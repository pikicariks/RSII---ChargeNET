...
{
    /// <inheritdoc />
    public partial class DatabaseSchemaMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PowerRating = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    PricePerKWh = table.Column<decimal>(type: "decimal(10,4)", nullable: false),
                    PricePerMinute = table.Column<decimal>(type: "decimal(10,4)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasCCS = table.Column<bool>(type: "bit", nullable: false),
                    HasCHAdeMO = table.Column<bool>(type: "bit", nullable: false),
                    HasType2 = table.Column<bool>(type: "bit", nullable: false),
                    MaxPowerKW = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    IsFastCharger = table.Column<bool>(type: "bit", nullable: false),
                    HasIndoor = table.Column<bool>(type: "bit", nullable: false),
                    Has24hAccess = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChargingStations_StationStatuses_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PowerKW = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Connectors_ChargingStations_ChargingStationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StationVectors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StationVectors_ChargingStations_ChargingStationId",
                        column: x => x.ChargingStationId,
                        principalTable: "ChargingStations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalChargedKWh = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalRating = table.Column<decimal>(type: "decimal(2,1)", nullable: true),
                    LastVisitedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LikeStatus = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserStationProfiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserStationProfiles_ChargingStations_ChargingStationId",
                        column: x => x.ChargingStationId,
                        principalTable: "ChargingStations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserStationProfiles_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vehicles_ConnectorTypes_ConnectorTypeId",
                        column: x => x.ConnectorTypeId,
                        principalTable: "ConnectorTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FaultReports_ChargingStations_ChargingStationId",
                        column: x => x.ChargingStationId,
                        principalTable: "ChargingStations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FaultReports_Connectors_ConnectorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceOrders_ChargingStations_ChargingStationId",
                        column: x => x.ChargingStationId,
                        principalTable: "ChargingStations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ServiceOrders_FaultReports_FaultReportId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnergyConsumedKWh = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChargingStations_StatusId",
                table: "ChargingStations",
                column: "StatusId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Connectors_ChargingStationId_ConnectorTypeId_Label",
                table: "Connectors",
                columns: new[] { "ChargingStationId", "ConnectorTypeId", "Label" },
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FaultReports_ChargingStationId",
                table: "FaultReports",
                column: "ChargingStationId");

            migrationBuilder.CreateIndex(
                name: "IX_FaultReports_ConnectorId",
                table: "FaultReports",
                column: "ConnectorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_UserId_StatusId",
                table: "Reservations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceOrders_ChargingStationId",
                table: "ServiceOrders",
                column: "ChargingStationId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceOrders_FaultReportId",
                table: "ServiceOrders",
                column: "FaultReportId");

            migrationBuilder.CreateIndex(
                name: "IX_StationStatuses_Name",
                table: "StationStatuses",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StationVectors_ChargingStationId",
                table: "StationVectors",
                column: "ChargingStationId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserStationProfiles_ChargingStationId",
                table: "UserStationProfiles",
                column: "ChargingStationId");

            migrationBuilder.CreateIndex(
                name: "IX_UserStationProfiles_UserId_ChargingStationId",
                table: "UserStationProfiles",
                columns: new[] { "UserId", "ChargingStationId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserWallets_StripeCustomerId",
                table: "UserWallets",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vehicles_ConnectorTypeId",
                table: "Vehicles",
                column: "ConnectorTypeId");
